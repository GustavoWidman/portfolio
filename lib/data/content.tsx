		...
		about: {
			...
			p2: (
				<>
					...
					<span className="text-black dark:text-white font-semibold">Rust</span>{" "}
					kernels for fun, architect reproducible{" "}
					<span className="text-black dark:text-white font-semibold">NixOS</span>{" "}
			...
			p3: (
				<>
					Whether configuring high-security VPNs with WireGuard or building
					distributed Go microservices, I prioritize correctness, security, and
					performance.
				</>
			),
		},
		...
		about: {
			...
			p2: (
				<>
					...
					<span className="text-black dark:text-white font-semibold">Rust</span>{" "}
					por diversão, arquiteto infraestruturas{" "}
					<span className="text-black dark:text-white font-semibold">NixOS</span>{" "}
			...
			p3: (
				<>
					Seja configurando VPNs seguras com WireGuard ou construindo
					microsserviços distribuídos em Go, priorizo corretude, segurança e
					performance.
				</>
			),
		},

...
import camelsec_logo from "@/icons/camelsec_logo.jpg";
import echosec_logo from "@/icons/echosec_logo.jpg";
    ...
    about: {
      ...
      p2: (
        <>
          ...
          architect reproducible <span className="text-black dark:text-white font-semibold">NixOS</span>{" "}
          infrastructures for work, and break them both during{" "}
          <span className="text-black dark:text-white font-semibold">red team</span> operations.
        </>
      ),
      p3: (
        <>
          Whether configuring high-security VPNs with WireGuard or building distributed Go microservices,
    ...
    about: {
      ...
      p2: (
        <>
          ...
          <span className="text-black dark:text-white font-semibold">Rust</span> por diversão, arquiteto
          infraestruturas <span className="text-black dark:text-white font-semibold">NixOS</span>{" "}
          reprodutíveis profissionalmente e quebro ambos em operações de{" "}
          <span className="text-black dark:text-white font-semibold">red team</span>.
        </>
      ),
      p3: (
        <>
          Seja configurando VPNs seguras com WireGuard ou construindo microsserviços distribuídos em Go,
          priorizo corretude, segurança e performance.
        </>
      ),
    },
    stack: {
...
export const STATIC_EXPERIENCE: Experience[] = [
  {
    id: "camelsec",
    company: "CamelSec",
    // logo: <Shield className="w-full h-full text-white" fill="currentColor" />,
    logo: <img src={camelsec_logo} alt="CamelSec Logo" className="w-full h-full object-cover rounded" />,
    positions: [
      {
        role: "Chief Technology Officer (CTO)",
  ...
  },
  {
    id: "echosec",
    company: "EchoSec",
    logo: <img src={echosec_logo} alt="EchoSec Logo" className="w-full h-full object-cover rounded" />,
    positions: [
      {
        role: "Counselor",
    ...
    positions: [
      {
        ...
        endDate: "2025-04-01",
        description: [],
        techStack: ["Vite", "React", "TypeScript", "Python", "NodeJS", "C# / .NET", "MSSQL", "MySQL"],
      },
    ],
  },
];

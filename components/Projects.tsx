import { Brain, Container, Cpu, Lock, Server, Shield, Terminal as TerminalIcon } from "lucide-react";
import React from "react";
import { LuGithub } from "react-icons/lu";
import { DATA, STATIC_PROJECTS } from "../data/content";
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto">
        <h3 className="text-xs font-mono text-zinc-500 dark:text-zinc-600 mb-24 uppercase tracking-widest">
          {t.projects.title}
        </h3>

...
const Hero: React.FC<HeroProps> = ({ scrollY, lang, theme, scrollTo, startTerminal = true }) => {
  ...
  // Memoize scroll-based style calculations to prevent unnecessary recalculations
  // Only enable will-change when actively scrolling to reduce GPU memory overhead
...
// Only re-render when scrollY changes significantly (every 10px)

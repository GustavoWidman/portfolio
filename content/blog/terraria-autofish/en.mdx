...
![image of my old python ocr setup](/blog/terraria-autofish/ocr-debug.png)
...
![decompiled C# code of FishingCheck_RollItemDrop showing the fisher.rolledItemDrop variable](/blog/terraria-autofish/dnspy-code.png)
...
![disassembled code of FishingCheck showing the creation of FishingContext and the pointer to _context](/blog/terraria-autofish/disassembly.png)
...
![screenshot of the final rust app running with trace logging enabled showing the scan finding the pattern and following the pointer](/blog/terraria-autofish/final-run.png)

...
![imagem do meu setup antigo de ocr em python](/blog/terraria-autofish/ocr-debug.png)
...
![screenshot do código c# descompilado de FishingCheck_RollItemDrop mostrando a variável fisher.rolledItemDrop](/blog/terraria-autofish/dnspy-code.png)
...
![screenshot do código assembly desmontado de FishingCheck mostrando a criação do FishingContext e o ponteiro para _context](/blog/terraria-autofish/disassembly.png)
...
![screenshot do app final em rust rodando com trace logging ativado mostrando o scan encontrando o padrão e seguindo o ponteiro](/blog/terraria-autofish/final-run.png)
